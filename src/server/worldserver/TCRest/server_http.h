  ...
  protected:
    ...
    public:
      ...
      void set_timeout(long seconds) noexcept {
        ...
        // timer = std::unique_ptr<asio::steady_timer>(new asio::steady_timer(get_socket_executor(*socket), std::chrono::steady_clock::duration &seconds));//,std::chrono::seconds(seconds))
